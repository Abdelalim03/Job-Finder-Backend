...
const { createTask, deleteTask, updateTask, getTasks, getTaskById, filterTasks } = require("../controllers/tasks.controller.js");
...
tasksRouter.route("/filter").get(authenticateToken,filterTasks)
